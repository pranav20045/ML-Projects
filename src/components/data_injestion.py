...
## this class will be used to take input from any source
@dataclass
...
class DataInjestion:
    ...
    def initiate_data_injestion(self):
        logging.info("Entered the data injestion mehtod or component")
        # we can take input from any data source here 
        try:
            ...
            logging.info("Injestion of dtaa completed")
